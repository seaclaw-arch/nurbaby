// Import Supabase dari npm package
import { createClient } from '@supabase/supabase-js';

// Konfigurasi Supabase dari environment variables
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || 'https://ycmbvotfmxijznonetpm.supabase.co';
const SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || 'sb_publishable_56wQ5Elt7GbQwZ2d2iS-cQ_69QvJYAo';
